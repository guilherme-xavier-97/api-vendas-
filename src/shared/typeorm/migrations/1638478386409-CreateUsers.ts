...
export class CreateUsers1638478386409 implements MigrationInterface {
    name = 'CreateUsers1638478386409'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "public"."orders_products" ADD "product_id" uuid NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "public"."orders_products" DROP COLUMN "product_id"`);
